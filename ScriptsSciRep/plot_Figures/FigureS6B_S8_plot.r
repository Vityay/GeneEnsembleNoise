...
load('CAP_WGCNA_XGB.Rdat')
XGB_model_bst <- xgb.load('CAP_WGCNA_XGB.model')
...
pdf("FigureS8A.pdf", width=4, height=9)
...
################################################################################
pdf("FigureS6B.pdf", width=6, height=6)
...
setwd("/media/yuri/Data/home1/GNI_data/infection/ResultsSciRep/Figures/")
pdf("FigureS8B.pdf", width=4, height=9)
