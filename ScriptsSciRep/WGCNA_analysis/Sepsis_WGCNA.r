...
affyData_SPS <- affyData_out[,pheno$d == "other"]
phenotype_SPS <- pheno$mort[pheno$d == "other"]

datExpr = t(affyData_SPS)
GeneNames = rownames(affyData_SPS)
