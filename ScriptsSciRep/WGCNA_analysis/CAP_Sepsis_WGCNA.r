...
affyData_CAP_SPS <- affyData_out[,pheno$d != "ctl"]

datExpr = t(affyData_CAP_SPS)
GeneNames = rownames(affyData_CAP_SPS)
...
phenotype <- pheno$mort[pheno$d != "ctl"]
# signif(cor(datME, as.numeric(phenotype), use="p"), 2)

setwd("/media/yuri/Data/home1/GNI_data/infection/ResultsSciRep")
save.image("CAP_sepsis_WGCNA.Rdat")
