...
load("COVID_logCPM.Rdat")

datExpr = t(COVID_logCPM)
GeneNames = rownames(COVID_logCPM)
...
phenotype = unclass(as.factor(COVID_pheno$stage))
# signif(cor(datME,phenotype, use="p"), 2)

setwd("/media/yuri/Data/home1/GNI_data/infection/ResultsSciRep/")
save.image("COVID_WGCNA.Rdat")
