...
rm(adj, affyData, affyData_CAP, affyData_out, cex1, datExpr, dissTOM,
  dynamicMods, geneTree, minModuleSize, phenotype_CAP, powers,
  samples, samples_pData, samples_pData_subset, sft, softPower, TOM)


pheno <- pheno[pheno$d == "cap",]
...
save.image('CAP_WGCNA_XGB.Rdat')
xgb.save(XGB_model_bst, 'CAP_WGCNA_XGB.model')
