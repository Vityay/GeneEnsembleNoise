...
rm(adj, affyData, affyData_CAP_SPS, affyData_out, cex1, datExpr, dissTOM,
  dynamicMods, geneTree, minModuleSize, phenotype, powers,
...
save.image('CAP_sepsis_WGCNA_XGB.Rdat')
xgb.save(XGB_model_bst, 'CAP_sepsis_WGCNA_XGB.model')
